...
const __FlashStringHelper* trivia(int n) {
    switch (n) {
        ...
        case 486: return F("Some items land upside-down on Mario Galaxy");
        case 487: return F("In Ultimate, the minimap is curved on Mario Galaxy");
        case 488: return F("Mario Circuit was originally going to have toads in karts");
        case 489: return F("In Ultimate, you can sort of exceed 999% in the lava on Super Mario Maker");
        case 490: return F("Super Mario Maker terrain got buggy after Steve was added");
        case 491: return F("You can't rotate the camera at all on Super Mario Maker");
        case 492: return F("Super Mario Maker is the only 3DS stage based on a Wii U game");
        case 493: return F("On 3DS, Star KOs only happen on Super Mario Maker and Duck Hunt");
        case 494: return F("The Super Mario Maker stage reveal trailer called Charizard \"Lizardon\"");
        case 495: return F("Super Mario Maker is the only 3DS stage with a slippery surface");
        case 496: return F("Yoshi's Island's internal codename is \"yoshi_cartboard\"");
        case 497: return F("Yoshi's Island is the only Smash 64 stage not in Smash 4");
        case 498: return F("Yoshi's Island has an orange background in training mode on N64");
        case 499: return F("Yoshi's Island and Halberd are the only stages with their own spirits");
        case 500: return F("Shielding & facing right on a cloud in Yoshi's Island causes you to tumble");
        case 501: return F("Yoshi's Island (Melee)'s top platform was raised when Steve was added");
        case 502: return F("Metal Mario's trophy has a reflection of Yoshi's Island (Melee)");
        case 503: return F("On Yoshi's Island (Melee) the spinning blocks will spin forever if you hang");
        case 504: return F("In Melee, the \"walk\" AI goes crazy on the spinning blocks in Yoshi's Island");
        case 505: return F("During Olimar's FS, you can see Raphael the Raven's moon on Yoshi's Island");
        case 506: return F("Only the third Yoshi's Island is based on the game Yoshi's Island");
        case 507: return F("Kongo Jungle has a different name in every smash game");
        case 508: return F("Kongo Jungle was the first stage with fully vocalized music");
        case 509: return F("Jungle Japes' internal codename is \"dk_lodge\"");
        case 510: return F("In Brawl, the Klaptrap on Jungle Japes can be meteor cancelled");
        case 511: return F("In Melee, Jungle Japes is the only stage missing its original song");
        case 512: return F("The top of Jungle Japes has a large starburst that can only be seen in VR");
        case 513: return F("75m should be called \"75 m\" under SI unit standard");
        case 514: return F("75m is the only stage with no extra unlockable music tracks in Brawl");
        case 515: return F("Maxim Tomatoes never appear in Hyrule Castle in the original game");
        case 516: return F("In Smash 4 Wii U, 5/6 songs on Hyrule Castle are just the Zelda main theme");
        case 517: return F("Hyrule Castle's background is fixed, only the camera moves");
        case 518: return F("Great Bay was planned to have the Marine Research Lab & character cameos");
        case 519: return F("Temple was going to have an elevator, but it was cut (melee beta)");
        case 520: return F("Only Temple and 75m do not appear in Classic or All-Star in Smash 4");
        case 521: return F("Gamer & Temple were originally going to be unlockable on Wii U");
        case 522: return F("The rain on Pirate Ship is actually 2d");
        case 523: return F("Pirate Ship is the only DLC (Wii U) stage that doesn't add new music");
        case 524: return F("Pirate Ship was intended for the 3ds but it couldn't handle it");
        case 525: return F("Only Gerudo Valley on 3ds has an old remix by default, and a new remix backup");
        case 526: return F("On 3DS, Sonic with speed items, bunny hood and curry can outrun Spirit Train");
        case 527: return F("On 3DS if you tech the track on Spirit Train, you clip and land in the train");
        case 528: return F("The fewest assist trophies can appear on Spirit Train");
        case 529: return F("Star KOs were removed from Skyloft and Mushroom Kingdom U in development");
        case 530: return F("Brinstar's internal codename was \"ZEBES\" in melee");
        case 531: return F("Brinstar's new internal codename is \"metroid_zebesdx\"");
        case 532: return F("On Brinstar if Master/Crazy Hand dies in Stamina mode, they will bounce forever");
        case 533: return F("Super & Poision Mushrooms never appear on Brinstar Depths in smush");
        case 534: return F("Mushroom Kingdom's melee codename was \"INISHIE1\" (and INISHIE2 for 2)");
        case 535: return F("Race to the Finish's melee codename was \"TUKISUSUME\"");
        case 536: return F("Melee had a cut fire-emblem stage codenamed AKANEIA");
        case 537: return F("Mr. Saturn's melee codneame was DOSEI");
        case 538: return F("Melee had planned 6-player support, but it was never completed");
        case 539: return F("Marth, Ike and Lucario can counter Norfair's lava wave");
        case 540: return F("Norfair appears in the most classic routes (14)");
        case 541: return F("Frigate Orpheon is the only Metroid stage without lava or acid");
        case 542: return F("Japanese players voted Dream Land the most fair stage in Melee & 64 in 2004");
        case 543: return F("Dream Land appears in the most games (5, including Wii U & 3DS)");
        case 544: return F("A Double Dedede can occur (rarely) on Dream Land");
        case 545: return F("Dream Land in Smash 4 is the only DLC stage legal in competitive play");
        case 546: return F("Whispy Woods's nose is not attached to his face");
        case 547: return F("The reflections on Fountain of Dreams go away with 5+ players");
        case 548: return F("Green Greens' bomb block explosions are oddly cpu-intensive when zoomed in");
        case 549: return F("Halberd's laser crosshair bugs out if targeting someone who uses the Dragoon");
        case 550: return F("Halberd's Brawl model was re-used in Kirby Super Star Ultra");
        case 551: return F("In Brawl' the warning sign on the Halberd has an upside-down Meta Knight symbol");
        case 552: return F("Star KOs cannot occur on Dream Land GB");
        case 553: return F("Dream Land GB was originally supposed to be a Super Mario Land stage");
        case 554: return F("The burning sound effect for Danger Zones on Great Cave Offensive is broken");
        case 555: return F("Wario can permanently lose his bike on Great Cave Offensive");
        case 556: return F("Lightning Bolts, Super & Poision Mushrooms can't appear on Great Cave Offensive");
        case 557: return F("Great Cave Offensive was originally based on Kirby's Epic Yarn");
        case 558: return F("Any characters in a cannon will be invulnerable to Timers");
        case 559: return F("Kirby's Epic Yarn was originally a non-Kirby game, with the character \"Fluff\"");
        case 560: return F("Yoshi's Wooly World contains all the stage files from Kirby's Epic Yarn");
        case 561: return F("Young Link's shield can block the lasers on Corneria");
        case 562: return F("Some absorption moves redirect the lasers on Corneria in weird directions");
        case 563: return F("The Ike Grab Glitch can only be performed on Corneria");
        case 564: return F("\"sans is the best smash character\" - Contributed by Leslie");
        case 565: return F("\"s t e v e\" - Contributed by Leslie");
        case 566: return F("\"*the first four notes of Megalovania*\" - Contributed by Leslie");
        case 567: return F("There is a hidden black cube in the center of Venom");
        case 568: return F("Lylat Cruise is the only Star Fox stage that is not on the Great Fox");
        case 569: return F("Lylat Cruise is the only Star Fox stage with no hazards");
        case 570: return F("Lylat Cruise is the only tournament-legal stage where Steve only mines Iron");
        case 571: return F("C.Falcon can go through the Silph Co door on Saffron City");
        case 572: return F("In Ultimate, the pokemon on Saffron City are voiced from the anime");
        case 573: return F("Pokemon Stadium is the only pokemon stage with no pokemon");
        case 574: return F("Venusaur was originally supposed to appear on Pokemon Stadium 1");
        case 575: return F("The Pokemon Stadium jumbotron doesn't update when swapping Pyra/Mythra");
        case 576: return F("In Brawl, a full Wario Waft on Pokemon Stadium 2's Flying mode always KOs");
        case 577: return F("Pokemon Stadium 2's jumbotron lacks a bunch of text in Omega/Battlefield form");
        case 578: return F("Cresselia has no connection to Spear Pillar in the Pokemon games");
        case 579: return F("Mesprit can fly offstage in Spear Pillar because it is a roaming Pokemon");
        case 580: return F("Unova Pokemon League had the most design changes between 3DS and Ultimate");
        case 581: return F("Prism Tower has a mix of elements from the games and the anime");
        case 582: return F("Registeel is the only legendary on Kalos Pkmn League that did not appear before");
        case 583: return F("One player used to spawn oddly closer to the center in Kalos Pkmn League pre3.1");
        case 584: return F("The layout of the track in Big Blue is randomly generated");
        case 585: return F("Greninja can outrun the stage on Big Blue with a Bunny Hood");
        case 586: return F("If Electrode falls off Big Blue he bounces repeatedly until exploding");
        case 587: return F("The lightning boosters on Port Town Aero Drive don't do anything");
        case 588: return F("Mute City has high knockback on the track, but P.CityAeroDr has it on the cars");
        case 589: return F("The Onett message board has a warning about Lucky, from Runaway 5");
        case 590: return F("Onett is the only Melee stage used to unlock a character in Brawl");
        case 591: return F("Onett is the only tournament-legal Earthbound stage ever");
        case 592: return F("Fourside has a full moon in the Special Movie");
        case 593: return F("In Melee, AIs usually airdodge to recover on Fourside, often dying");
        case 594: return F("Repeatedly wavedashing on the UFO on Fourside in Melee gains tons of speed");
        case 595: return F("A hawaiian shirt was added to Fourside in Ultimate as a reference to Everdred");
        case 596: return F("In Brawl, the Empire Porky building is even taller than the skybox");
        case 597: return F("Shadow Sneak will sometimes warp off the ground on New Pork City");
        case 598: return F("The Pigmask logo is stamped into all platforms on New Pork City");
        case 599: return F("On 3DS, character shadows are missing on one platform of Magicant");
        case 600: return F("The flying men on Magicant were originally 3d");
        case 601: return F("Ultimate Chimera, and the fish & bear from Summit lack trophies in Brawl");
        case 602: return F("Ice Climber (Brawl) and Icicle Mountain (Melee) sync with the stage on Summit");
        case 603: return F("Sonic can outrun the iceberg on Summit w/ Giant Brawl & hood, curry & S.mushrm");
        case 604: return F("The fish on Summit will attempt to swallow Wario-Man, but fail");
        case 605: return F("Any shield timing will perfect shield the iceberg hitting you on Summit");
        case 606: return F("The original masked man spirit was actually fanart and had to be removed");
        case 607: return F("Male and Female Byleth have different names (Bereto & Beresu) in Japanese");
        case 608: return F("The flag at the end of Mushroomy Kingdom blows opposite to everything else");
        case 609: return F("Olimar's FS always flies through the other side of Frigate Orpheon");
        case 610: return F("The ship in New Donk City doesn't have enough moons to be there");
        case 611: return F("Riki has \"Ecru Type\" hair in sm4sh, but his default hair in smush");
        case 612: return F("Inkling's hair catches fire like their special is ready when they have a FS");
        case 613: return F("Summit is the only stage where Steve places Ice");
        case 614: return F("Peach has 4 idle animations but Daisy only has 2");
        case 615: return F("Terry's parry animation is taken from a spin-off game (Capcom vs SNK 2)");
        case 616: return F("Zelda lost an idle animation in Ultimate");
        case 617: return F("Kirby's parry animation is taken from his shielding pose in Kirby Super Star");
        case 618: return F("Banjo's parry animation is a reference to the one-up trophies in his games");
        case 619: return F("Meta Knight is the only character whose eyes turn red when he has a FS");
        case 620: return F("Zombie is the only character whose eyes do not change color when he has a FS");
        case 621: return F("In Brawl, Castle Siege's animations complete faster if you pause");
        case 622: return F("In Smash 4, the sun on Castle Siege changes color after the first cycle");
        case 623: return F("In Countdown, Castle Siege's flag is the emblem of Askr");
        case 624: return F("Arena Ferox is the first FE stage based on a specific location");
        case 625: return F("Arena Ferox is the only FE stage with no walk-offs");
        case 626: return F("Arena Ferox means \"fierce arena\" in Latin");
        case 627: return F("Colliseum got a visual update in v3.1 of Ultimate");
        case 628: return F("Flat Zone X's text was changed from \"SMASH BROS\" to \"SUPER SMASH BROS\" in Smush");
        case 629: return F("Flat Zone X has the fewest music tracks (2)");
        case 630: return F("Midgar used to tie for fewest music tracks (2) until it got more music");
        case 631: return F("Ironically Palutena's Army is significantly less effective on Skyworld in Brawl");
        case 632: return F("The Wii U 50-Fact Extravaganza said Skyworld was from Zelda");
        case 633: return F("The game logo on the stage select screen for Skyworld has changed every game");
        case 634: return F("Steve's down smash and down tilt don't damage the platforms on Skyworld");
        case 635: return F("Viridi was much smaller and had roses on Reset Bomb Forest early on in Smash 4");
        case 636: return F("In Sm4sh Wrath of the Reset Bomb synced with the stage and paused with the game");
        case 637: return F("The Reset Bomb Forest castle ruins are visible when fighting Ganon in Classic");
        case 638: return F("Reset Bomb Forest's transition sounds are stored twice, one in \"Japanese\"");
        case 639: return F("Reset Bomb Forest can be zoomed in the furthest on 3DS");
        case 640: return F("Palutena's Temple has the most songs from a single game (9, from Uprising)");
        case 641: return F("You can get stuck in the floor if on a ledge during a WarioWare Inc. microgame");
        case 642: return F("Both Nana and Popo must complete the microgames on WarioWare Inc");
        case 643: return F("In Brawl, AI set to \"stop\" will still complete microgames on WarioWare Inc");
        case 644: return F("In All-Star and Wario's unlock battle on 3DS, WarioWare Inc has no microgames");
        case 645: return F("In the original game, you fall asleep if hiding too long on Gamer");
        case 646: return F("On Wii U, Gamer is the only stage with a Original Games/Settings tip");
        case 647: return F("The outer walls on Gamer have no collision");
        case 648: return F("Wario's bike is unaffected by the flowing water on Distant Planet");
        case 649: return F("Sonic with a Bunny Hood can overcome the water on Distant Planet");
        case 650: return F("In Brawl, CPUs think Bulborb's mouth is a ledge, and SD to it on Distant Planet");
        case 651: return F("Distant Planet is the only Brawl stage to get a new remix on 3DS");
        case 652: return F("Garden of Hope is used for the most Spirit battles (26)");
        case 653: return F("If Olimar uses End of Day on Garden of Hope, he lands on the pot");
        case 654: return F("Smashville is the only stage from a universe to debut before the fighter");
        case 655: return F("Smashville's clock shows the actual time");
        case 656: return F("Smashville wasn't a valid Animal Crossing town name until New Horizons");
        case 657: return F("Smashville's Japanese name is a pun on an abbreviation of \"smash brothers\"");
        case 658: return F("In Brawl and Wii U, Kapp'n drives his taxi through a tree on Smashville");
        case 659: return F("In Brawl and Wii U, Able's shop name is in French on Smashville");
        case 660: return F("Boxing Ring lists Villager's title as \"Mayor of Smashville\"");
        case 661: return F("Smashville is the only stage on Wii U to not use normal crates");
        case 662: return F("Tortimer Island is the only Animal Crossing stage where K.K.Slider can't appear");
        case 663: return F("The Metal Box texture on Town & City is always rendered as if it is daytime");
        case 664: return F("Boxing Ring is the most common stage in Classic (12 routes, 20 rounds)");
        case 665: return F("Luigi's Boxing Ring title \"The Eternal Understudy\" references Smash 64");
        case 666: return F("Dr. Mario's Spanish Boxing Ring title references the band \"Jarabe de Palo\"");
        case 667: return F("Piranha Plant's French Boxing Ring title is a reference to the movie Jaws");
        case 668: return F("Yoink's French Boxing Ring title is a reference to the Pied Piper of Hamelin");
        case 669: return F("Ridley's Boxing Ring title \"Cunning God of Death\" is from Metroid Zero Mission");
        case 670: return F("Dedede's Boxing Ring title Self-made King is from Guest Star ?? Star Allies Go");
        case 671: return F("Mewtwo's Boxing Ring title references Genesect & the Legend Awakened");
        case 672: return F("Pichus French Boxing Ring \"petit chou\" means smol cabbage but sounds like Pichu");
        case 673: return F("Lucas' Boxing Ring title is Boy from Nowhere because he is from Nowhere Island");
        case 674: return F("Little Mac's Boxing Ring title \"Bruiser from the bronx\" references Rick Bruiser");
        case 675: return F("Inkling's Japanese Boxing Ring title has puns on both \"ikashita\" and \"ika\"");
        case 676: return F("Wii Fit Studio's Omega form is the only one that changes with 8 players");
        case 677: return F("Alucard is the only assist trophy blocked from a stage not due to an issue");
        case 678: return F("The 3DS version of Gaur Plain has smaller blast zones and lacks many platforms");
        case 679: return F("Gaur Plain is the only stage to have its default song changed in an update");
        case 680: return F("Star & Screen KOs occur on Duck Hunt on 3DS but not Wii U");
        case 681: return F("Jigglypuff can jump & rest to clip through a regen wall in Shadow Moses Island");
        case 682: return F("The bridge on Green Hill Zone slows down some attacks like Wario Bike");
        case 683: return F("In Brawl, The first letters of the 4 \"Zone\" songs on Green Hill Zone spell SEGA");
        case 684: return F("Puff w/ 2 thistle badges & light gravity can stay up forever on Windy Hill Zone");
        case 685: return F("Yellow Devil is from Megaman, but appears on Wily Castle from Megaman 2");
        case 686: return F("Even with hazards off, Wily Castle is \"too close to FD\" for competitive play :P");
        case 687: return F("The screen won't even zoom out on Pac-Land for a Little Mac KO uppercut");
        case 688: return F("Pac-Land is the only stage with no music from its game");
        case 689: return F("The kanju on Suzaku Castle references The Art of War");
        case 690: return F("Neither Ryu or Ken are fought on Suzaku Castle for their unlock battles");
        case 691: return F("\"forward aerial.\" - Contributed by Jessie");
        case 692: return F("Midgar appears as a stage in the 2015 Dissidia Final Fantasy");
        case 693: return F("Midgar was the only stage on Wii U with no smash-specific arrangements");
        case 694: return F("Midgar is the only Smash 4 stage that can crush");
        case 695: return F("Odin's attack on Midgar uses a searchbox and can hit a fighter twice");
        case 696: return F("Sonic's eyes turn grey on Midgar on Wii U");
        case 697: return F("Umbra Clock Tower displays the real time");
        case 698: return F("Falling rocks on Umbra Clock Tower got glitchy in Ultimate");
        case 699: return F("Hanenbow has no \"My Music\" in Brawl but the ambience track was in the game data");
        case 700: return F("Performing Rollout on some platforms of Hanenbow gives huge speed");
        case 701: return F("PictoChat 2 is the only sequel whose original is not from Brawl");
        case 702: return F("PictoChat 2 is the only 3ds stage with only recycled music");
        case 703: return F("If you land on a Dolphin on PictoChat 2 before it enters the stage, you die");
        case 704: return F("Using a Timer during Faucet on PictoChat2 desyncs the next sketch from hitboxes");
        case 705: return F("The platforms on Balloon Fight are modeled in 3d, with special camera settings");
        case 706: return F("Because of Balloon Fight 3DS is the first time a Bumper and Flipper both appear");
        case 707: return F("Kirby's Stone can remove blocks on Living Room, even with hazards off");
        case 708: return F("There is a fireplace offscreen to the right in Living Room");
        case 709: return F("Omnislash can KO yourself with the right timing on Find Mii");
        case 710: return F("Find Mii is the only stage with a \"!\" in its name in any language: German");
        case 711: return F("Warp Stars never spawn on Tomodatchi Life on 3DS");
        case 712: return F("Tomodatchi Life is randomly generated using 6/12 possible rooms");
        case 713: return F("Outside of Wrecking Mario & Bros & Spirits, Wrecking Crew has infinite floors");
        case 714: return F("Players stuck under a barrel on Wrecking Bros can always be attacked by allies");
        case 715: return F("You can get stuck under a barrel forever on Wrecking Bros due to Stage Morph");
        case 716: return F("The 2d islands on Pilotwings never appeared in the original game");
        case 717: return F("The Pilotwings stall over Wuhu Island was removed in Ultimate");
        case 718: return F("The Pilotwings biplane uses the original route, the yellow one uses the 64route");
        case 719: return F("You can see the Pilotwings plane in the background of Wuhu Island");
        case 720: return F("Akira's voice clips are from Virtua Fighter 4");
        case 721: return F("Akira has appeared in a bunch of random games, mostly with Sonic");
        case 722: return F("Bayonetta uses Tetsuzanko for her fthrow, and references Akira's line in JP");
        case 723: return F("Alucard's full name is Adrian Fahrenheit Tepes");
        case 724: return F("Alucard is technically a dhampir");
        case 725: return F("Alucard was considered to be playable in place of Simon or Richter");
        case 726: return F("Alucard and Zero got new voice clips in Ultimate");
        case 727: return F("Alucard and Zero have the same japanese voice actor");
        case 728: return F("Andross, Nintendog and Zero are tied for the most spirits at 3");
        case 729: return F("ABCDE was changed to \"A. Bunny\" on Arcade Bunny's model in Smash");
        case 730: return F("Ashley's PAL trophy description references her theme song");
        case 731: return F("Barbara is unlocked in Brawl after collecting 25 CDs");
        case 732: return F("Barbara will dissapear before the music ends on 1.5x speed");
        case 733: return F("Only Black Knight and Spring Man do not appear in their own spirit battles");
        case 734: return F("Bomberman's artist passed away 1 day before he was confirmed for Ultimate :(");
        case 735: return F("Bomberman's trophy is directly from Super Bomberman R");
        case 736: return F("Louie's notes on Burrowing Snagret detail how to cook it");
        case 737: return F("Burrowing Snagret was originally called Burrowing Snarrow");
        case 738: return F("Burrowing Snagret is the only boss to appear in all 3 Pikmin games");
        case 739: return F("Burrowing Snagret's latin name is Shiropedes anacondii, or Whitefoot Anaconda");
        case 740: return F("The Smash 4 trophy of Chain Chomp uses its new design, but the old one in game");
        case 741: return F("Brawl's chain chomp trophy incorrectly said they were undefeatable in Mario 64");
        case 742: return F("In the Kirby games, Kirby can copy Chef Kawasaki's abilities");
        case 743: return F("Color TV-Game 15 is the oldest game in Smash from 1977");
        case 744: return F("Color TV-Game 15 is the only assist trophy without a spirit");
        case 745: return F("Dark Samus' assist trophy only fires its final shot if it is close to a fighter");
        case 746: return F("Devil had a Melee trophy in JP but nowhere else");
        case 747: return F("Devil can move the entire stage offscreen on Pirate Ship");
        case 748: return F("Devil is the oldest assist trophy in Brawl, from 1984");
        case 749: return F("Devil is the most restricted assist trophy, he cannot appear on 67 stages");
        case 750: return F("Only Nintendogs and Dillon received major visual updates between games");
        case 751: return F("Dr. Ryuta Kawashima is a real neuroscientist who studies learning in Japan");
        case 752: return F("Dr. Kawashima has a game called Body and Brain Connection for the Kinect");
        case 753: return F("Dr. Kawashima and ROB are the only real-life representatives in Smash");
        case 754: return F("Dr. Wright is from the SNES version of Sim City");
        case 755: return F("If you attack Dr. Wright he just builds taller buildings");
        case 756: return F("Elec Man is the only 3rd-party assist trophy not in Ultimate");
        case 757: return F("Elec Man and Magnus are the only assist trophies removed in Ultimate");
        case 758: return F("Excitebikes are not assist trophies in Smash 4, but appear in Smash Tour");
        case 759: return F("Flies & Hand used the SNES Mouse in Mario Paint");
        case 760: return F("Gnat Attack reappeared in WarioWare Mega Microgame$! and Super Mario Maker");
        case 761: return F("Despite being playable in Gnat Attack F&H is listed in trophies as non-playable");
        case 762: return F("Ghirahim reflects projectiles");
        case 763: return F("The ghosts on Pac-Maze can be hit if you collect 100 pac-dots");
        case 764: return F("Blinky and Pinky were replaced with fairies in Pac-Man's down taunt");
        case 765: return F("In Metal Gear, Gray Fox can deflect bullets with his sword");
        case 766: return F("Gray Fox's voice lines are taken from The Twin Snames");
        case 767: return F("If Gray Fox appears on pictochat with two walls on the stage, he gets stuck");
        case 768: return F("Gray Fox's spirit photo is actually Raiden in a DLC costume in Revengance");
        case 769: return F("Gray Fox and Issac are the only assist trophies to skip a game");
        case 770: return F("In KR, Gray Fox uses his JP voice lines, but Snake uses his English ones");
        case 771: return F("Guile's hitsounds are straight from Street Fighter IV");
        case 772: return F("Both of Guile's ground attacks have light and heavy versions");
        case 773: return F("Guile's JP voice actor also voiced Lt. Surge in Pokemon Masters EX & the anime");
        case 774: return F("Hammer Bros take reduced indirect damage in Brawl");
        case 775: return F("Mute City SNES is the only stage where Hammer Bros cannot appear");
        case 776: return F("Hammer Bros is the only Assist Trophy trophy you can get with a trophy stand");
        case 777: return F("Helirin is from Kuru Kuru Kururin");
        case 778: return F("Helirin can be used as a solid platform to stand on");
        case 779: return F("Helirin is the only Assist Trophy ever with a Novice class spirit");
        case 780: return F("The sound when Infantry & Tanks are summoned is from the intro to Famicom Wars");
        case 781: return F("Infantry & Tanks artwork & DOJO!! entry show an HQ, but there isn't one in game");
        case 782: return F("The Psynergy that Isaac uses in Brawl can't be used in battle in his game");
        case 783: return F("The Psynergy that Isaac got in Smush are for solving puzzles and visiting towns");
        case 784: return F("Isaac's Japanese name is Robin in his games");
        case 785: return F("You must complete 200 games to unlock Isaac in Brawl");
        case 786: return F("Isaac's hand uses the same model as Master Hand in Ultimate");
        case 787: return F("Isaac's voice actor also did Krystal on Lylat Cruise");
        case 788: return F("Isabelle debuted in 2012, making her the newest Assist Trophy in Smash 4");
        case 789: return F("Pears are the only fruit Isabelle throws not in her Smash 4 trophy");
        case 790: return F("Jeff fires more rockets if you are losing");
        case 791: return F("Jeff and his rockets don't have shadows in Ultimate for some reason");
        case 792: return F("The Drill Dozer can also fly in Jill's base game");
        case 793: return F("Kapp'n is the only assist trophy who can't appear on any of his serie's stages");
        case 794: return F("Kat & Ana are canonically ninjas, but also kindergartners");
        case 795: return F("Kat & Ana will let you automatically tech any wall in Smash Tour");
        case 796: return F("Klaptraps can get stuck in the barrel cannon on Kongo Jungle");
        case 797: return F("Klaptrap is the only non-human DK character in Ultimate with a known VA");
        case 798: return F("Knuckle Joe is also a recurring character in Kirby: Right Back at Ya!");
        case 799: return F("Kawasaki is notoriously unskilled, and owns the only restaurant in Cappy Town");
        case 800: return F("Chef Kawasaki tries to cook Kirby alive in Kirby: Right Back at Ya!");
        case 801: return F("Kirby Super Star is called Kirby's Fun Pack in Europe");
        case 802: return F("In Brawl, Knuckle Joe is voiced by A.Glidewell, who also voiced ZSS and Krystal");
        case 803: return F("KOing a Knuckle Joe now gives a point in Ultimate");
        case 804: return F("Knuckle Joe is the only basic enemy assist trophy not an enemy in Smash Run");
        case 805: return F("Ultimate is the last game ever where Travis Willingham voices Knuckles");
        case 806: return F("Guile and Knuckles are both voiced by Travis Willingham");
        case 807: return F("Krystal was considered for a playable character in Brawl");
        case 808: return F("Orbital Gate Assault took an entire year to develop");
        case 809: return F("Orbital Gate Assault is the only stage with no Wolfens");
        case 810: return F("End of Day on Orbital Gate Assault during the missile explosion bugs platforms");
        case 811: return F("Orbital Gate Assault is the only stage with a Smash Taunt missing in Ultimate");
        case 812: return F("Five stages were removed between Smash 4 and Ultimate");
        case 813: return F("Krystal was originally going to be the protaganist of the game Dinosaur Planet");
        case 814: return F("Lakitu's cloud was called \"Jugem's Cloud\" in Super Mario Bros");
        case 815: return F("Miyamoto said that Lakitu is the character who represents him the most");
        case 816: return F("Little Mac is the only AT who was later playable representing a new franchize");
        case 817: return F("Lyn's name is actually Lyndis");
        case 818: return F("Lyn is so fast in Brawl she can hit Sonic out of his final smash");
        case 819: return F("Lyn will retaliate rapidly if you hit her");
        case 820: return F("Magnus will say \"Sorry I'm late. I had other things to attend to\"");
        case 821: return F("Magnus is voiced by different actors between Uprising and Smash 4");
        case 822: return F("Metroids can move through platforms like the Phazon Metroids in MP3: Corruption");
        case 823: return F("The baby metroid from M2RoS appears in Melee's opening movie");
        case 824: return F("Repeatedly attacking Midna will stunlock her until she dissapears");
        case 825: return F("Midna's attacks are technically all grabs and cannot be shielded");
        case 826: return F("Mr. Resetti's lectures in Brawl can last for over one minute");
        case 827: return F("Attacking Mr. Resetti just makes him talk more");
        case 828: return F("Smash balls will not appear while Mr. Restti is on stage");
        case 829: return F("Moon in the background of Great Bay got updated to look like MM3D in Ultimate");
        case 830: return F("Mother Brain's Laser Brain attack will always shield break");
        case 831: return F("Mother Brain's Laser Brain attack deals 90% if all hits connect");
        case 832: return F("Nightmare is voiced by Hisao Egawa, unlike in the anime");
        case 833: return F("Nightmare now also hides shields in ultimate");
        case 834: return F("Nikki has also appeared in the Japanese newsletter \"Nintendo News\"");
        case 835: return F("Nikki is the first Assist Trophy not from a video game");
        case 836: return F("Nikki can't appear on Final Destination, but can appear on its battlefield form");
        case 837: return F("Camera controls cannot be used when Nikki is present");
        case 838: return F("Nikki appeared as a Mii Gunner costume in an amiibo promition, but never got it");
        case 839: return F("Nikki is the only assist trophy that can give a final smash");
        case 840: return F("Victini and Munchalax are the only pokemon to use an ability instead of a move");
        case 841: return F("Four different Nintendog breeds have stickers in Brawl!");
        case 842: return F("Miyamoto came up with the idea for Nintendogs");
        case 843: return F("ROB was a ploy to get the NES allowed in toy stores after the Crash of 1983");
        case 844: return F("Wii U had 6 nintendogs trophies!");
        case 845: return F("There are 3 nintendogs spirits!");
        case 846: return F("Nintendog is the only Assist Trophy who can also appear on stage simultaniously");
        case 847: return F("Phosphora's VA switched from Kari Wahlgren to Stephanie Komure in Smash 4");
        case 848: return F("Phosphora will flinch but cannot be defeated in Smash 4");
        case 849: return F("Rathalos' Japanese name is Liolaeus");
        case 850: return F("Monster Hunter's Mii costumes are crafted from Rathalos parts");
        case 851: return F("You can attack Rathalos' tail for an item when he is a boss");
        case 852: return F("Rathalos' boss fight's items reference Flash & Barrel Bombs & Pitfall from MH");
        case 853: return F("Rathalos is the only boss fight in Ultimate with item drops");
        case 854: return F("Rathalos is the only boss from a franchize with no characters, items or stages");
        case 855: return F("No Brawl fighters face Rathalos as their classic boss");
        case 856: return F("Ray Mk II is the newest assist trophy in Brawl, debuting October 2006");
        case 857: return F("During Chain Attack, Riki has his Biter and uses Lurgy");
        case 858: return F("Happy Happy raises Attack in Brawl, but Speed in Ultimate");
        case 859: return F("Only Riki and Spring Man appear outside assist trophies as a non-enemy");
        case 860: return F("Riki is the only character who appears under multiple sound test folders");
        case 861: return F("If you scan a sm4sh amiibo in Bayonetta 2, Rodin asks to join your \"fight club\"");
        case 862: return F("Four assist trophies do not appear in any spirit battles");
        case 863: return F("All combat in Prince of Sable's game takes place in a dust cloud");
        case 864: return F("Prince of Sable's sword was modeled specifically for smash but never used");
        case 865: return F("Prince of Sable is the only Assist Trophy to have debuted on Game Boy");
        case 866: return F("Saki Amamiya was added as an AsstTrophy because of strong demand from JP gamers");
        case 867: return F("Saki Amamiya's weapon is called the Dolphin Gun");
        case 868: return F("Samurai Goroh's Fire Stingray can be seen on Mute City");
        case 869: return F("Samurai Goroh was initially called \"Samurai Goro\" in DOJO!!");
        case 870: return F("Samurai Goroh appears when winning All-Star Mode as Ike");
        case 871: return F("Samurai Goroh's shirt means either \"extremely\", \"violent\" or \"raging\"");
        case 872: return F("In Brawl & 4, Samurai Goroh was confirmed before Captain Falcon was");
        case 873: return F("Shadow is the only assist trophy to change VAs between games");
        case 874: return F("Shadow is the only assist trophy to appear in an intro movie");
        case 875: return F("Sheriff's Melee trophy was only in the Japanese version");
        case 876: return F("In 4, Sheriff's shots can be reflected, but not in Ultimate. +Can't be absorbed");
        case 877: return F("In Ultimate, if you shield a Sherrif shot, he shoots faster");
        case 878: return F("Shovel Knight is the first Assist Trophy from an independent developer");
        case 879: return F("Shovel Knight's Shovel Drop attack was inspired by Link in Zelda II");
        case 880: return F("When Skull Kid reverses controls, it doesn't apply to taunts");
        case 881: return F("If Skull Kid makes someone invisible in Smash Tour, they reappear after dying");
    }
}
